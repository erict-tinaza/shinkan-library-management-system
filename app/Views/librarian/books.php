            ...
            <div class="mb-npx">
                <div class="row align-items-center">
                    <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                        <!-- Title -->
                        <h1 class="h2 mb-0 ls-tight">Manage Books</h1>
                    </div>
                    <!-- Actions -->
        ...
        <div class="container-fluid">
            ...
            <div class="container my-2">
                ...
                <div class="table-responsive">
                    <table id="myBooksTable" class="table table-striped">
                        <thead class="bg-primary">
                            <tr>
                                <th class="text-light">book_id</th>
                                <th class="text-light">title</th>
                                <th class="text-light">Author_ID</th>
                                <th class="text-light">ISBN</th>
                                <th class="text-light">quantity</th>
                                <th class="text-light">available_quantity</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                    </table>
                ...
                <div class="modal fade" id="add_modal_books" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="" id="frmbooks">
                                <div class="modal-body">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title" class="form-control" id="floatingInputTitle" placeholder="name@example.com">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="isbn" class="form-control" id="floatingInputISBN" placeholder="name@example.com">
                                        <label for="floatingInputISBN">ISBN</label>
                                        <div class="text-danger" id="error_isbn"></div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="quantity" class="form-control" id="floatingInputQTY" placeholder="name@example.com">
                                        <label for="floatingInputQTY">Quantity</label>
                                        <div class="text-danger" id="error_qty"></div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="available_quantity" class="form-control" id="floatingInputAvailQTY" placeholder="name@example.com">
